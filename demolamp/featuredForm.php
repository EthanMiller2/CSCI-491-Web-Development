        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="exampleModalLabel">An email will be sent to us with the info you input!</h5>
            ...
            <div class="modal-body">
              <form name="bandRequest" method="post" action ="featured.php" >
                ...
                <div class="form-group">
                  <label for="exampleFormControlTextarea1">Input some information about the Artist</label>
